...
class FuncoesSAT(object):
    ...
    def enviar_dados_venda(self, dados_venda,chave=False,data_hora=False,valor=False,funcao=False):
        ...
        if funcao:
            ...
            return self.comando_sat('NfeAutorizacaoLote12.xml', consulta=consulta)
        else:
            consulta = {
                'numero_sessao': self.gerar_numero_sessao(),
                'codigo_ativacao': self._codigo_ativacao,
